...
- [ ] The same applies to internal domains, internal URLs, secret/service names, or other internal-only info  
  社内ドメイン・内部URL・シークレット名/サービス名などの社内限定情報についても同様に、編集・削除済みのものも含めて一度も含めていない
- [ ] I have actually checked the edit history of this PR/issue/commits (not just the current text) for the above  
  現在の表示上の文面だけでなく、このPR/Issue/コミットの編集履歴も実際に確認した
